...
void main_function(int argc, char **argv)
{
    ...
    double perc = (parameters["popSize"] - parameters["eilte"]) / parameters["popSize"]; //eilite
   ...
   fileMonitor.add(SecondStat);
    ...
    fout << "Best : " << gga.best << endl << gga.best.D[0] << endl << gga.best.D[1] << endl << gga.best.D[2] << endl << gga.best.Dun << endl << gga.best.ATT;
    fout.close();
